...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gap-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gap-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add gap gap-core gap-defaults
# for installing globally
pixi global install gap gap-core gap-defaults
```
...
It is possible to list all of the versions of `gap` available on your platform:
...
```
pixi search gap --channel conda-forge
```
